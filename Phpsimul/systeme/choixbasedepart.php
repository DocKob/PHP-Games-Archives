...
function choixbasedepart()
{
    ...
    if ($controlrow["coordonnees_activees"] == 1) 
	{
        ...
        $echo = "<center>Vous n'avez pas de " . $controlrow["nom_bases"] . ". 
				 Veuillez séléctionner un emplacement libre de la liste ci dessous afin de vous y installer : 
				 <br>
				 <br>
				 <form action='index.php' method='post'>Coordonnées : 
				 <table border='0'>
				 <tr>
				";
        ...
        $echo .= "<td><input type='text' name='ordre_2' value='" . $ordre_2 . "'></td></tr></table>
				  <br>
        ...
        while ($numero_ordre_3 <= $controlrow["ordre_3_max"]) 
		{
			...
			{
                $echo .= "<tr align='center'><td align='center'>" . $numero_ordre_3 . "</td><td align='center'>&nbsp;</td><td align='center'><a href='index.php?mod=choixbasedepart2|" . $ordre_1 . "|" . $ordre_2 . "|" . $numero_ordre_3 . "'>S'installer ici</a></td><td align='center'> - </td></tr>";
            }
    ...
    else // Si les coordonnées sont inactives
    {
...
function choixbasedepart2($ordre_1, $ordre_2, $ordre_3)
{
    global $userrow;
    global $controlrow;
    global $sql;
